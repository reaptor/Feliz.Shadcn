    ...
    UI.PreviewAndCode(
        ...
        Shadcn.hoverCard [
            Shadcn.hoverCardTrigger [
                ...
                prop.children [ Shadcn.button [ button.variant.link; prop.text "@nextjs" ] ]
            ]
            Shadcn.hoverCardContent [
                ...
                prop.children [
                    Html.div [
                        ...
                        prop.children [
                            Shadcn.avatar [
                                Shadcn.avatarImage [ prop.src "https://github.com/vercel.png" ]
                                Shadcn.avatarFallback "VC"
                            ]
                            Html.div [
                                prop.className "space-y-1"
                                prop.children [
                                    Html.h4 [ prop.className "text-sm font-semibold"; prop.text "@nextjs" ]
                                    Html.p [
                                    ...
                                    Html.div [
                                        ...
                                        prop.children [
                                            Lucide.Calendar [ svg.className "mr-2 h-4 w-4 opacity-70" ]
                                            Html.span [
