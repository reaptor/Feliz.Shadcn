...
let rec Menubar () =
        ...
        Shadcn.menubar [
            ...
            Shadcn.menubarMenu [
                ...
                Shadcn.menubarContent [
                    ...
                    Shadcn.menubarSeparator []
                    Shadcn.menubarItem [ prop.custom ("inset", true); prop.text "Toggle Fullscreen" ]
                    Shadcn.menubarSeparator []
                    Shadcn.menubarItem [ prop.custom ("inset", true); prop.text "Hide Sidebar" ]
                ]
            ]
            Shadcn.menubarMenu [
                ...
                Shadcn.menubarContent [
                    ...
                    Shadcn.menubarSeparator []
                    Shadcn.menubarItem [ prop.custom ("inset", true); prop.text "Edit..." ]
                    Shadcn.menubarSeparator []
                    Shadcn.menubarItem [ prop.custom ("inset", true); prop.text "Add Profile..." ]
                ]
            ]
        ],
        """Shadcn.menubar [
    Shadcn.menubarMenu [
        ...
        Shadcn.menubarContent [
            Shadcn.menubarItem [
                prop.children [
                    Html.text "New Tab "
                    Shadcn.menubarShortcut "⌘T"
                ]
            ]
            Shadcn.menubarItem [
                prop.children [
                    Html.text "New Window "
                    Shadcn.menubarShortcut "⌘N"
                ]
            ]
            Shadcn.menubarItem [
                prop.disabled true
                prop.text "New Incognito Window"
            ]
            Shadcn.menubarSeparator []
            Shadcn.menubarSub [
                Shadcn.menubarSubTrigger "Share"
    ...
    Shadcn.menubarMenu [
        Shadcn.menubarTrigger "View"
        Shadcn.menubarContent [
            Shadcn.menubarCheckboxItem [
                prop.text "Always Show Bookmarks Bar"
            ]
            Shadcn.menubarCheckboxItem [
                menubarCheckboxItem.checked' true
                prop.text "Always Show Full URLs"
            ]
            Shadcn.menubarSeparator []
            Shadcn.menubarItem [
                prop.custom ("inset", true)
            ...
            Shadcn.menubarItem [
                prop.custom ("inset", true)
                prop.text "Toggle Fullscreen"
            ]
            Shadcn.menubarSeparator []
            Shadcn.menubarItem [
                prop.custom ("inset", true)
                prop.text "Hide Sidebar"
            ]
        ]
    ]
    Shadcn.menubarMenu [
